...
const contable = earnings.toLocaleString("es-ES", {useGrouping: true});
  ...
  return (
    <div className={style.summary__container}>
      ...
      <p className={style.summary__paragraph}> <span className={style.summary__span}>Mi link:</span> https://www.linkapp.com.co/tienda?id={link}</p>
      ...
      <p className={style.summary__paragraph1}><span className={style.summary__span}>Fecha ultima actualización: </span> {reportedDate.toLocaleDateString()}</p>
