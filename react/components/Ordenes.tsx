      ...
      <div className={styles.results}>
        {currentOrders.map((order, index) => (
          <div className={styles.results__container} key={index}>
            ...
            <p className={styles.results__text}><span className={styles.results__span}>Total de la compra: </span>{numbro((order?.orderValue)/100).format('$0,0')}</p>
          </div>
        ))}
      </div>
